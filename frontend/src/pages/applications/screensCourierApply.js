        ...
        h(GlassPanel, { key: "side", className: "mb-8 lg:sticky lg:top-6 lg:mb-0" }, [
          h("div", { className: "flex items-start gap-3" }, [
            ...
            h("div", { className: "min-w-0" }, [
              h("h2", { className: "font-display text-lg font-bold text-slate-900 dark:text-white" }, "Delivery partner"),
              ...
              [
                ...
                h(Field, { key: "notes", label: "About your delivery experience & availability" }, [
                  h(TextArea, {
                    ...
                    placeholder: "Where you operate, usual hours, any ID you already carry, delivery areas, …"
                  }),
