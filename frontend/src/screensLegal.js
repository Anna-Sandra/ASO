...
import { h } from "./h";
import { GlassPanel, LogoMark, ThemeToggleButton } from "./ui";
  ...
  return h("div", { className: "page-topbar" }, [
    h("div", { className: "page-topbar-inner" }, [
      h(Link, { to: "/", className: "flex items-center gap-2" }, [
        ...
        h("span", { key: "t", className: "font-display text-lg font-bold text-sky-700 dark:text-sky-300" }, "Campus Mart")
      ]),
  ...
  return h("div", { className: "page-app-shell" }, [
    ...
    h("div", { key: "main", className: "mx-auto max-w-3xl px-4 py-8 sm:px-6" }, [
      ...
      h(GlassPanel, null, [
        ...
        h("p", { className: "mt-1 text-sm text-slate-500 dark:text-slate-400" }, "Last updated: 24 April 2026. Please read these terms carefully before using Campus Mart."),
          ...
          proseWrap([
            h("section", { key: "1" }, [
              ...
              h(
                "p",
                { className: "mt-2" },
                "Campus Mart (“we”, “us”, “our”) is an online marketplace that connects students and other buyers with independent sellers offering goods and services. We provide the platform, technology, and tools; unless stated otherwise, we are not the seller of items listed on the site and we do not take ownership of your purchases."
              )
            ]),
            h("section", { key: "2" }, [
            ...
            h("section", { key: "3" }, [
              ...
              h("ul", { className: "mt-2 list-disc space-y-1 pl-5" }, [
                h("li", null, "You must be able to form a binding contract in your country of residence. If you use Campus Mart on behalf of an organization, you represent that you have authority to bind that organization."),
            ...
            h("section", { key: "6" }, [
              ...
              h("p", { className: "mt-2" }, "You must not use Campus Mart to list, request, or facilitate:"),
              h("ul", { className: "mt-2 list-disc space-y-1 pl-5" }, [
            ...
            h("section", { key: "8" }, [
              ...
              h("ul", { className: "mt-2 list-disc space-y-1 pl-5" }, [
                ...
                h(
                  "li",
                  null,
                  "To the maximum extent permitted by law, Campus Mart and its operators are not liable for indirect, incidental, or consequential damages, or for loss of profit, data, or goodwill, arising from your use of the platform."
                ),
                h(
                  "li",
                  null,
            ...
            h("section", { key: "10" }, [
              ...
              h(
                "p",
                { className: "mt-2" },
                "These terms are intended to be interpreted in line with the laws of the jurisdiction in which Campus Mart primarily operates, without regard to conflict-of-law rules, except where consumer protections in your country cannot be waived."
              ),
              h(
                "p",
                { className: "mt-3" },
...
/** Rules that apply to vendors (sellers) on Campus Mart. */
export function VendorRulesPage() {
  return h("div", { className: "page-app-shell" }, [
    ...
    h("div", { key: "main", className: "mx-auto max-w-3xl px-4 py-8 sm:px-6" }, [
      ...
      h(GlassPanel, null, [
        h("h1", { className: "font-display text-2xl font-bold text-slate-900 dark:text-white" }, "Campus Mart vendor rules"),
        ...
        h("div", { className: "mt-6 space-y-6 text-sm leading-relaxed" }, [
          proseWrap([
            h("section", { key: "v1" }, [
              ...
              h("ul", { className: "mt-2 list-disc space-y-1 pl-5" }, [
                h("li", null, "Selling on Campus Mart requires an approved vendor application. We may request identity or student verification; false information can lead to rejection or account closure."),
            ...
            h("section", { key: "v3" }, [
              ...
              h(
                "p",
                { className: "mt-2" },
                "Unless the platform offers a specific delivery program, you must clearly communicate how and when the buyer will receive the goods (pickup, on-campus handover, third-party courier, etc.), and you must make reasonable efforts to meet the timelines you communicate."
              )
            ]),
            h("section", { key: "v4" }, [
