...
export const listVendorApplications = asyncHandler(async (req: Request, res: Response) => {
  ...
  res.json({
    applications: rows.map((r) => {
      ...
      locationLat: (r as { locationLat?: number }).locationLat ?? null,
      locationLng: (r as { locationLng?: number }).locationLng ?? null,
      locationLabel: (r as { locationLabel?: string }).locationLabel || "",
      ...
      locationBase: (r as { locationBase?: string }).locationBase || "",
      nearbyArea: (r as { nearbyArea?: string }).nearbyArea || "",
      status: r.status,
      adminNote: r.adminNote,
      createdAt: r.createdAt,
